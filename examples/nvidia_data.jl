...
# Path to the NVDA.csv file
csv_path = joinpath(@__DIR__, "..", "data", "NVDA.csv")
...
plt = Plot(trace, Layout(title="NVDA Candlestick Chart"))

# Ensure generated directory exists and save interactive HTML
gen_dir = joinpath(@__DIR__, "..", "generated")
mkpath(gen_dir)
html_path = joinpath(gen_dir, "nvda_candlestick.html")
